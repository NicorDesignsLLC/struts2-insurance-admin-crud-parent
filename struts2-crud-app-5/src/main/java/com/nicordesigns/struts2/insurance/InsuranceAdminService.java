...
//			bretry = false;
//			try {
//				//logger.info("----------retrieving the agents for webID: " + webId);
//				conn = funServLocator.getMySQLConnection();
//				ps = conn.prepareStatement(sqlCode.getSQLStatement(SQLKeyConstants.SELECT_ENROLLERS_MYSQL));
...
//					optionItem.setLabel(rs.getString("AGENTNAME_ID"));
//					optionItem.setValue(rs.getString("AGENTID"));
//					arr.add(optionItem);
//				}
//				//logger.info("----------successfully retrieved the producers");
